...
import { CalendarIcon, TrendingUp, Settings, BarChart3, Play } from "lucide-react";
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
            Configure your trading strategy parameters and run comprehensive backtests 
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card>
                <CardHeader className="pb-4">
                  ...
                  <CardDescription>Choose the stock and time period for backtesting</CardDescription>
                </CardHeader>
                    ...
                    <div className="space-y-4">
                      <div className="grid grid-cols-2 gap-4">
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel>Short Window</FormLabel>
                              <FormControl>
                                <Input
                                  type="number"
                                  min="1"
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel>Long Window</FormLabel>
                              <FormControl>
                                <Input
                                  type="number"
                                  min="2"
                ...
                <CardContent className="pt-6">
                  <div className="flex items-center justify-center py-12">
                    ...
                    <span className="ml-2 text-slate-600 dark:text-slate-400">
                      Fetching market data and running backtest...
                    </span>
                  </div>
                </CardContent>
              </Card>
